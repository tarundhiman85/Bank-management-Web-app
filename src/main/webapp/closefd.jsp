        ...
        <div class="col-md-4 offset-md-4">
            <div class="card">
                <div class="card-body px-5">
                    <h4 class="text-center my-3">Close FD Account Here</h4>
                    <form action="RegisterServlet" method="post">

                        <div class="form-group">
                            <label for="get1" >FD Account Number :</label>
                        ...
                        <div class="form-group">
                            <label for="get" >FD Amount :</label>
                            <input name="user_phone" required type="number" class="form-control" id="get2" placeholder="Enter FD Amount ">
                        </div>
